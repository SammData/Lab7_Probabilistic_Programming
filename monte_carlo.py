...
x_train, x_test, y_train, y_test = train_test_split(
    mnist.data, mnist.target, test_size=0.2, random_state=2020,
)
...
plt.figure(figsize=(8, 6))
sns.distplot(
    simulations_dt["p"].numpy(), label="DecisionTree", color="red"
)
sns.distplot(
